package com.sun.dateStructure.queue;

/**
 * @Title
 *
栈是“后进先出”（LIFO，Last InFirst Out）的数据结构，与之相反，
队列是“先进先出”（FIFO，First InFirst Out）的数据结构.
栈的插入和删除数据项的命名方法很标准，成为push和pop，队列的方法至今也没有一个标准化的方法，
插入可以称作put、add或enque等，删除可以叫作delete、get、remove或deque等.
